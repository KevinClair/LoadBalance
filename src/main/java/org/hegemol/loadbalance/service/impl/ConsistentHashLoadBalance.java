 ...
 * @author KevinClair
 **/
public class ConsistentHashLoadBalance extends AbstractLoadBalance<ConsistentHashInstance> {

    private static final String INSTANCE = "-INSTANCE-";

    @Override
    protected Instance doLoad(final List<ConsistentHashInstance> instances, final String ip) {
